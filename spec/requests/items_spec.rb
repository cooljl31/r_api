...
RSpec.describe 'Items API' do
  subject(:todo) { create(:todo, created_by: user.id) }
  ...
  describe 'POST /todos/:todo_id/items' do
    let(:valid_attributes) { { name: 'Sirop go!', done: false }.to_json }
  ...
  describe 'PUT /todos/:todo_id/items/:id' do
    let(:valid_attributes) { { name: 'Sirop' }.to_json }
    ...
    context 'when item exists' do
      ...
      it 'updates the item' do
        ...
        expect(updated_item.name).to match(/Sirop/)
      end
    end
